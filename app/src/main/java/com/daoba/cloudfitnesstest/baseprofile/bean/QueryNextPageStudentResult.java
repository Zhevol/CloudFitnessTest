...
/**
 * 分页查询所有参加体测的学生的结果，不带处理缓存版本，可以直接调用这个来获取剩余的信息
 *
 * @author Zhevol
 * @date 2018/3/23 0023
 */
public class QueryNextPageStudentResult {

    private String currentExceptionMessage;
    private QueryNextPageStudentData data;
    ...
    public QueryNextPageStudentData getData() {
        return data;
    }
    ...
    public static class QueryNextPageStudentData {
