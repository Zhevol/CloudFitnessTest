package com.daoba.cloudfitnesstest.baseprofile.net;

import android.app.ProgressDialog;
import android.content.Context;
import android.widget.Toast;

import com.daoba.cloudfitnesstest.baseprofile.config.HttpConfig;
...
public class SoapHttpManager {
    ...
    private String md5(String str) {
        ...
        Logger.i("源字符串：" + str + "，加密结果:" + sb.toString());
        return sb.toString();
    }
